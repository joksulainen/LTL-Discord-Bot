...
1. Install [Python 3.14](https://www.python.org/downloads/) through your preferred method.
...
1. Install [Python 3.14](https://www.python.org/downloads/) and [uv](https://github.com/astral-sh/uv) through your preferred method. Not much needs to be said here.
1. Install project dependencies by running `uv sync` in project directory.
